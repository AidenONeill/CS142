...
public class PassByValue
{
	...
	public static void main (String args [])
	{
		...
		changeX(x); //QUESTION 1: What value is x after this method call? Why?  		10, the method changeX, assigns the value 17 to the copy of x but the original stays unchanged
		...
		x = changeX2(x);//Question 2: What value is x after this method call? Why  		27. the method changeX2 assignes the value 27 to x
		...
		printHelper(array);
		changeArray(array);//Question 3: What is the contents of the array after this call? Why? 		10000,20000,30,40, the method changeArray assigns new values to array index 0 and 1
		...
		printHelper();
		changeArray();//Question 4: What is the contents of the array after the call? Why?				10, 13,25,30, the method changes the first and second value in the arrray
		...
		printHelper(array);
		reassignArray(array);//N.B. Question5: What is the value of the array after this call? Why?  		10000,20000,30,40, reassignArray only changed the value of the array within its own method, the memory address of the original array remains the same.
		...
		System.out.println("\n****************************************\n");
		s1 = setNewString2(s1);//Question 6: How did we manage to change s1?				s1 was assigned a new string and returned from the method.
